...
class ProxiesBase(object):
    ...
    def max_page(self, header_list: list) -> str:
        ...
        try:
            ...
            # 输出 log 信息
            logging.error(f"Method max_page: the error of getting web page: {e}")
            # 声明 html
            html = ""
        # 条件判断
        if not html:
    ...
    def get_page(url: str, header_list: list) -> str:
        ...
        try:
            ...
            # 输出 log 信息
            logging.error(f"Method get_page: the error of getting web page: {e}")
    ...
    def get_proxy(html: str) -> Generator:
        ...
        try:
            ...
            # 输出 log 信息
            logging.error(f"Method get_proxy: the error of getting field: {e}")
    ...
    def all_proxies(self, header_list: list) -> list:
        ...
        :param header_list: 请求头列表
        :return all_proxies_list: 所有 ip 代理池
        """
        # 输出 log 信息
        ...
        # 输出 log 信息
        logging.info("Method all_proxies: exiting the module of all_proxies ....")
        # 返回 all_proxies_list
    ...
    def verify_proxies(all_proxies_list: list) -> list:
        ...
        :return verified_proxies_list: 有效的代理 ip 列表
        """
        # 输出 log 信息
